...
const DailyExpensesPage = () => {
  ...
  useEffect(() => {
    ...
    const gamesFromYesterday = allGames
        .filter(g => g.clubId === activeClubId && startOfDay(new Date(g.timestamp)).getTime() === yesterdayStart)
  ...
  }, [selectedDate, activeClubId, allGames]);
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage daily income, expenses, and profit/loss for your club.</CardDescription>
        </CardHeader>
        <CardContent>
            ...
            {activeClubId && (
                ...
                <Separator className="my-6" />
                 <div ref={reportRef} className="space-y-6 bg-background p-0 md:p-4 rounded-lg">
                    {/* Summary Cards */}
